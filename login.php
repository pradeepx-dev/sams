...
<head>
    ...
    <style>
        body {
            ...
            flex-direction: column; /* Allow navbar and form in a column */
        ...
        .navbar {
            ...
            position: sticky;
            top: 0;
            width: 94%; /* Ensure navbar stretches across the page */
        ...
        .container {
            ...
            width: 400px;
            text-align: center;
            margin-top: 20px; /* Provide slight gap from navbar */
        }
        h2 {
            margin-bottom: 20px;
            color: #333;
...
<body>
    <div class="navbar">
        ...
        <ul class="nav-links">
            ...
            <a href="index.php #features-section"><li>Features</li></a>
            <a href="index.php #about-section"><li>About</li></a>
        </ul>
    </div>
